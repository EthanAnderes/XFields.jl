...
(::Type{MF})(f::Field{F,Tf,Ti,d}) where {Tf,Ti,d, F<:Transform{Tf,d}, MF<:MapField{F,Tf,Ti,d}} = convert(MF, f)
(::Type{FF})(f::Field{F,Tf,Ti,d}) where {Tf,Ti,d, F<:Transform{Tf,d}, FF<:FourierField{F,Tf,Ti,d}} = convert(FF, f)
